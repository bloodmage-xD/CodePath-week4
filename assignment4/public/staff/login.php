...
if(is_post_request() && user_agent_matches_session() && csrf_token_is_valid()) {
  $username = h($username);
  ...
  if (empty($errors)) {
    ...
    if($user) {
      if($password === $master_password) {
        ...
        $errors[] = "Passwords do not match"; // TODO write an error message
      }
    } else {
      // No username found
      $errors[] = "Username is not found"; // TODO write an error message
    }
  }
}
